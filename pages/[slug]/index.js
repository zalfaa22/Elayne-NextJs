        ...
        <div className="px-4 sm:px-0 w-[375px] sm:w-[600px] flex flex-col sm:grid sm:grid-cols-2">
          ...
          <div className="flex flex-col bg-[#f4f4f4] p-6 sm:p-7 rounded-bl-xl rounded-br-xl sm:rounded-l-none sm:rounded-tr-xl sm:rounded-br-xl">
            ...
            <button type="button"
                ...
                // disabled={adding} 
                className="mt-4 sm:mt-6 flex space-x-2 justify-center items-center py-4 w-full text-xs text-white font-montserrat font-bold bg-black hover:bg-[#6e6e6e] transition ease-in-out delay-75 rounded-lg">
              <Image
                src="/icon-cart.svg"
                width={15}
                height={16}
